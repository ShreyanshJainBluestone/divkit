...
pub struct DivAnimatorBaseBuilder {
    pub cancel_actions: Option<Vec<DivAction>>,
    pub direction: Option<Expression<DivAnimationDirection>>,
...
impl DivAnimatorBase {
    pub fn builder() -> DivAnimatorBaseBuilder {
        DivAnimatorBaseBuilder::default()
    }
...
impl DivAnimatorBaseBuilder {
    ...
    pub fn build(self) -> DivAnimatorBase {
        DivAnimatorBase {
            cancel_actions: self.cancel_actions,
            direction: self.direction.or_else(|| Some(DivAnimatorBase::default_direction())),
            ...
            interpolator: self.interpolator.or_else(|| Some(DivAnimatorBase::default_interpolator())),
            repeat_count: self.repeat_count.or_else(|| Some(DivAnimatorBase::default_repeat_count())),
            start_delay: self.start_delay.or_else(|| Some(DivAnimatorBase::default_start_delay())),
