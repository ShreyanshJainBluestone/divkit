...
impl DivBase {
    pub fn builder() -> DivBaseBuilder {
        DivBaseBuilder::default()
    }
...
impl DivBaseBuilder {
    ...
    pub fn build(self) -> DivBase {
        DivBase {
            ...
            height: self.height.or_else(|| Some(DivBase::default_height())),
            id: self.id,
            ...
            visibility: self.visibility.or_else(|| Some(DivBase::default_visibility())),
            visibility_action: self.visibility_action,
            visibility_actions: self.visibility_actions,
            width: self.width.or_else(|| Some(DivBase::default_width())),
        }
    }
}
