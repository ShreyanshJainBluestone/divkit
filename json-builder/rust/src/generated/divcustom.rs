...
pub struct DivCustom {
    ...
    #[serde(default = "DivCustom::default_type")]
    pub r#type: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl DivCustom {
    pub fn builder() -> DivCustomBuilder {
        DivCustomBuilder::default()
    }
...
impl DivCustomBuilder {
    ...
    pub fn custom_props(mut self, value: serde_json::Value) -> Self {
        self.custom_props = Some(value);
        self
    }
    pub fn custom_type(mut self, value: String) -> Self {
        self.custom_type = Some(value);
        self
    }
    ...
    pub fn build(self) -> DivCustom {
        DivCustom {
            ...
            visibility: self.visibility.or_else(|| Some(DivCustom::default_visibility())),
            visibility_action: self.visibility_action,
            visibility_actions: self.visibility_actions,
            width: self.width.or_else(|| Some(DivCustom::default_width())),
        }
    }
}
