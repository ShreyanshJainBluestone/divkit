...
pub struct DivGallery {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cross_content_alignment: Option<Expression<DivGalleryCrossContentAlignment>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cross_spacing: Option<Expression<i64>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub orientation: Option<Expression<DivGalleryOrientation>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub scroll_mode: Option<Expression<DivGalleryScrollMode>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub scrollbar: Option<Expression<DivGalleryScrollbar>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default = "DivGallery::default_type")]
    pub r#type: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl DivGallery {
    pub fn builder() -> DivGalleryBuilder {
        DivGalleryBuilder::default()
    }
    pub fn default_alpha() -> Expression<f64> { Expression::value(1.0_f64) }
    pub fn default_cross_content_alignment() -> Expression<DivGalleryCrossContentAlignment> { Expression::value(serde_json::from_str(r#""start""#).unwrap()) }
    ...
    pub fn default_item_spacing() -> Expression<i64> { Expression::value(8i64) }
    pub fn default_orientation() -> Expression<DivGalleryOrientation> { Expression::value(serde_json::from_str(r#""horizontal""#).unwrap()) }
    pub fn default_restrict_parent_scroll() -> Expression<bool> { Expression::value(true) }
    pub fn default_scroll_mode() -> Expression<DivGalleryScrollMode> { Expression::value(serde_json::from_str(r#""default""#).unwrap()) }
    pub fn default_scrollbar() -> Expression<DivGalleryScrollbar> { Expression::value(serde_json::from_str(r#""none""#).unwrap()) }
    pub fn default_type() -> String { "gallery".to_string() }
...
impl DivGalleryBuilder {
    ...
    pub fn cross_content_alignment(mut self, value: Expression<DivGalleryCrossContentAlignment>) -> Self {
        self.cross_content_alignment = Some(value);
        self
    }
    pub fn cross_spacing(mut self, value: Expression<i64>) -> Self {
        self.cross_spacing = Some(value);
        self
    }
    ...
    pub fn orientation(mut self, value: Expression<DivGalleryOrientation>) -> Self {
    ...
    pub fn scroll_mode(mut self, value: Expression<DivGalleryScrollMode>) -> Self {
        self.scroll_mode = Some(value);
        self
    }
    pub fn scrollbar(mut self, value: Expression<DivGalleryScrollbar>) -> Self {
    ...
    pub fn build(self) -> DivGallery {
        DivGallery {
            accessibility: self.accessibility,
            alignment_horizontal: self.alignment_horizontal,
            alignment_vertical: self.alignment_vertical,
            alpha: self.alpha.or_else(|| Some(DivGallery::default_alpha())),
            animators: self.animators,
            background: self.background,
            border: self.border,
            column_count: self.column_count,
            column_span: self.column_span,
            cross_content_alignment: self.cross_content_alignment.or_else(|| Some(DivGallery::default_cross_content_alignment())),
            cross_spacing: self.cross_spacing,
            default_item: self.default_item.or_else(|| Some(DivGallery::default_default_item())),
            disappear_actions: self.disappear_actions,
            extensions: self.extensions,
            focus: self.focus,
            functions: self.functions,
            height: self.height.or_else(|| Some(DivGallery::default_height())),
            id: self.id,
            item_builder: self.item_builder,
            item_spacing: self.item_spacing.or_else(|| Some(DivGallery::default_item_spacing())),
            items: self.items,
            layout_provider: self.layout_provider,
            margins: self.margins,
            orientation: self.orientation.or_else(|| Some(DivGallery::default_orientation())),
            paddings: self.paddings,
            restrict_parent_scroll: self.restrict_parent_scroll.or_else(|| Some(DivGallery::default_restrict_parent_scroll())),
            reuse_id: self.reuse_id,
            row_span: self.row_span,
            scroll_mode: self.scroll_mode.or_else(|| Some(DivGallery::default_scroll_mode())),
            scrollbar: self.scrollbar.or_else(|| Some(DivGallery::default_scrollbar())),
            ...
            r#type: String::from("gallery"),
            variable_triggers: self.variable_triggers,
            variables: self.variables,
            visibility: self.visibility.or_else(|| Some(DivGallery::default_visibility())),
            visibility_action: self.visibility_action,
            visibility_actions: self.visibility_actions,
            width: self.width.or_else(|| Some(DivGallery::default_width())),
        }
    }
}
