...
pub struct DivGifImage {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub preview_url: Option<Expression<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default = "DivGifImage::default_type")]
    pub r#type: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct DivGifImageBuilder {
    ...
    pub focus: Option<DivFocus>,
    pub functions: Option<Vec<DivFunction>>,
    pub gif_url: Option<Expression<String>>,
    pub height: Option<DivSize>,
    pub hover_end_actions: Option<Vec<DivAction>>,
    pub hover_start_actions: Option<Vec<DivAction>>,
    pub id: Option<String>,
...
impl DivGifImage {
    pub fn builder() -> DivGifImageBuilder {
        DivGifImageBuilder::default()
    }
    ...
    pub fn default_type() -> String { "gif".to_string() }
...
impl DivGifImageBuilder {
    ...
    pub fn gif_url(mut self, value: Expression<String>) -> Self {
        self.gif_url = Some(value);
        self
    }
    ...
    pub fn preview_url(mut self, value: Expression<String>) -> Self {
    ...
    pub fn build(self) -> DivGifImage {
        DivGifImage {
            accessibility: self.accessibility,
            action: self.action,
            action_animation: self.action_animation.or_else(|| Some(DivGifImage::default_action_animation())),
            actions: self.actions,
            alignment_horizontal: self.alignment_horizontal,
            alignment_vertical: self.alignment_vertical,
            alpha: self.alpha.or_else(|| Some(DivGifImage::default_alpha())),
            animators: self.animators,
            aspect: self.aspect,
            background: self.background,
            border: self.border,
            capture_focus_on_action: self.capture_focus_on_action.or_else(|| Some(DivGifImage::default_capture_focus_on_action())),
            column_span: self.column_span,
            content_alignment_horizontal: self.content_alignment_horizontal.or_else(|| Some(DivGifImage::default_content_alignment_horizontal())),
            content_alignment_vertical: self.content_alignment_vertical.or_else(|| Some(DivGifImage::default_content_alignment_vertical())),
            disappear_actions: self.disappear_actions,
            doubletap_actions: self.doubletap_actions,
            extensions: self.extensions,
            focus: self.focus,
            functions: self.functions,
            gif_url: self.gif_url.expect("missing required field 'gif_url'"),
            height: self.height.or_else(|| Some(DivGifImage::default_height())),
            ...
            placeholder_color: self.placeholder_color.or_else(|| Some(DivGifImage::default_placeholder_color())),
            preload_required: self.preload_required.or_else(|| Some(DivGifImage::default_preload_required())),
            ...
            scale: self.scale.or_else(|| Some(DivGifImage::default_scale())),
            ...
            r#type: String::from("gif"),
            variable_triggers: self.variable_triggers,
            variables: self.variables,
            visibility: self.visibility.or_else(|| Some(DivGifImage::default_visibility())),
            visibility_action: self.visibility_action,
            visibility_actions: self.visibility_actions,
            width: self.width.or_else(|| Some(DivGifImage::default_width())),
        }
    }
}
