...
pub struct DivNumberAnimator {
    ...
    #[serde(default = "DivNumberAnimator::default_type")]
    pub r#type: String,
    pub variable_name: String,
}

#[derive(Debug, Clone, Default)]
pub struct DivNumberAnimatorBuilder {
    pub cancel_actions: Option<Vec<DivAction>>,
    pub direction: Option<Expression<DivAnimationDirection>>,
...
impl DivNumberAnimator {
    pub fn builder() -> DivNumberAnimatorBuilder {
        DivNumberAnimatorBuilder::default()
    }
    ...
    pub fn default_type() -> String { "number_animator".to_string() }
}

impl DivNumberAnimatorBuilder {
    ...
    pub fn build(self) -> DivNumberAnimator {
        DivNumberAnimator {
            cancel_actions: self.cancel_actions,
            direction: self.direction.or_else(|| Some(DivNumberAnimator::default_direction())),
            ...
            interpolator: self.interpolator.or_else(|| Some(DivNumberAnimator::default_interpolator())),
            repeat_count: self.repeat_count.or_else(|| Some(DivNumberAnimator::default_repeat_count())),
            start_delay: self.start_delay.or_else(|| Some(DivNumberAnimator::default_start_delay())),
            start_value: self.start_value,
            r#type: String::from("number_animator"),
