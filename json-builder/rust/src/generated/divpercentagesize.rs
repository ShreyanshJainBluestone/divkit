...
pub struct DivPercentageSize {
    #[serde(default = "DivPercentageSize::default_type")]
    pub r#type: String,
    pub value: Expression<f64>,
}

#[derive(Debug, Clone, Default)]
pub struct DivPercentageSizeBuilder {
    pub r#type: Option<String>,
    pub value: Option<Expression<f64>>,
}

impl DivPercentageSize {
    pub fn builder() -> DivPercentageSizeBuilder {
        DivPercentageSizeBuilder::default()
    }
    pub fn default_type() -> String { "percentage".to_string() }
}

impl DivPercentageSizeBuilder {
    ...
    pub fn build(self) -> DivPercentageSize {
        DivPercentageSize {
