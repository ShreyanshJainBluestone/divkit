...
pub struct DivSeparator {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub delimiter_style: Option<DivSeparatorDelimiterStyle>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default = "DivSeparator::default_type")]
    pub r#type: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct DivSeparatorBuilder {
    pub accessibility: Option<DivAccessibility>,
    pub action: Option<DivAction>,
    pub action_animation: Option<DivAnimation>,
    pub actions: Option<Vec<DivAction>>,
...
impl DivSeparator {
    pub fn builder() -> DivSeparatorBuilder {
        DivSeparatorBuilder::default()
    }
    ...
    pub fn default_type() -> String { "separator".to_string() }
...
impl DivSeparatorBuilder {
    ...
    pub fn delimiter_style(mut self, value: DivSeparatorDelimiterStyle) -> Self {
        self.delimiter_style = Some(value);
        self
    }
    ...
    pub fn build(self) -> DivSeparator {
        DivSeparator {
            accessibility: self.accessibility,
            action: self.action,
            action_animation: self.action_animation.or_else(|| Some(DivSeparator::default_action_animation())),
            actions: self.actions,
            alignment_horizontal: self.alignment_horizontal,
            alignment_vertical: self.alignment_vertical,
            alpha: self.alpha.or_else(|| Some(DivSeparator::default_alpha())),
            animators: self.animators,
            background: self.background,
            border: self.border,
            capture_focus_on_action: self.capture_focus_on_action.or_else(|| Some(DivSeparator::default_capture_focus_on_action())),
            ...
            height: self.height.or_else(|| Some(DivSeparator::default_height())),
            ...
            r#type: String::from("separator"),
            variable_triggers: self.variable_triggers,
            variables: self.variables,
            visibility: self.visibility.or_else(|| Some(DivSeparator::default_visibility())),
            visibility_action: self.visibility_action,
            visibility_actions: self.visibility_actions,
            width: self.width.or_else(|| Some(DivSeparator::default_width())),
        }
    }
}
...
pub struct DivSeparatorDelimiterStyle {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub orientation: Option<Expression<DivSeparatorDelimiterStyleOrientation>>,
}

#[derive(Debug, Clone, Default)]
pub struct DivSeparatorDelimiterStyleBuilder {
    pub color: Option<Expression<String>>,
    pub orientation: Option<Expression<DivSeparatorDelimiterStyleOrientation>>,
}

impl DivSeparatorDelimiterStyle {
    pub fn builder() -> DivSeparatorDelimiterStyleBuilder {
        DivSeparatorDelimiterStyleBuilder::default()
    }
    pub fn default_color() -> Expression<String> { Expression::value("#14000000".to_string()) }
    pub fn default_orientation() -> Expression<DivSeparatorDelimiterStyleOrientation> { Expression::value(serde_json::from_str(r#""horizontal""#).unwrap()) }
}

impl DivSeparatorDelimiterStyleBuilder {
    pub fn color(mut self, value: Expression<String>) -> Self {
        self.color = Some(value);
        self
    }
    pub fn orientation(mut self, value: Expression<DivSeparatorDelimiterStyleOrientation>) -> Self {
        self.orientation = Some(value);
        self
    }
    pub fn build(self) -> DivSeparatorDelimiterStyle {
        DivSeparatorDelimiterStyle {
            color: self.color.or_else(|| Some(DivSeparatorDelimiterStyle::default_color())),
            orientation: self.orientation.or_else(|| Some(DivSeparatorDelimiterStyle::default_orientation())),
        }
    }
}

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq)]
pub enum DivSeparatorDelimiterStyleOrientation {
