...
pub struct DivState {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub default_state_id: Option<Expression<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub state_id_variable: Option<String>,
    pub states: Vec<DivStateState>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default = "DivState::default_type")]
    pub r#type: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct DivStateBuilder {
    ...
    pub selected_actions: Option<Vec<DivAction>>,
    pub state_id_variable: Option<String>,
    pub states: Option<Vec<DivStateState>>,
    pub tooltips: Option<Vec<DivTooltip>>,
    pub transform: Option<DivTransform>,
    pub transformations: Option<Vec<DivTransformation>>,
    pub transition_animation_selector: Option<Expression<DivTransitionSelector>>,
...
impl DivState {
    pub fn builder() -> DivStateBuilder {
        DivStateBuilder::default()
    }
    ...
    pub fn default_transition_animation_selector() -> Expression<DivTransitionSelector> { Expression::value(serde_json::from_str(r#""state_change""#).unwrap()) }
    pub fn default_type() -> String { "state".to_string() }
...
impl DivStateBuilder {
    ...
    pub fn default_state_id(mut self, value: Expression<String>) -> Self {
        self.default_state_id = Some(value);
        self
    }
    ...
    pub fn div_id(mut self, value: String) -> Self {
        self.div_id = Some(value);
        self
    }
    ...
    pub fn state_id_variable(mut self, value: String) -> Self {
        self.state_id_variable = Some(value);
        self
    }
    pub fn states(mut self, value: Vec<DivStateState>) -> Self {
    ...
    pub fn build(self) -> DivState {
        DivState {
            accessibility: self.accessibility,
            action: self.action,
            action_animation: self.action_animation.or_else(|| Some(DivState::default_action_animation())),
            actions: self.actions,
            alignment_horizontal: self.alignment_horizontal,
            alignment_vertical: self.alignment_vertical,
            alpha: self.alpha.or_else(|| Some(DivState::default_alpha())),
            animators: self.animators,
            background: self.background,
            border: self.border,
            capture_focus_on_action: self.capture_focus_on_action.or_else(|| Some(DivState::default_capture_focus_on_action())),
            clip_to_bounds: self.clip_to_bounds.or_else(|| Some(DivState::default_clip_to_bounds())),
            ...
            height: self.height.or_else(|| Some(DivState::default_height())),
            ...
            state_id_variable: self.state_id_variable,
            states: self.states.expect("missing required field 'states'"),
            tooltips: self.tooltips,
            transform: self.transform,
            transformations: self.transformations,
            transition_animation_selector: self.transition_animation_selector.or_else(|| Some(DivState::default_transition_animation_selector())),
            transition_change: self.transition_change,
            transition_in: self.transition_in,
            transition_out: self.transition_out,
            transition_triggers: self.transition_triggers,
            r#type: String::from("state"),
            variable_triggers: self.variable_triggers,
            variables: self.variables,
            visibility: self.visibility.or_else(|| Some(DivState::default_visibility())),
            visibility_action: self.visibility_action,
            visibility_actions: self.visibility_actions,
            width: self.width.or_else(|| Some(DivState::default_width())),
        }
    }
}
...
pub struct DivStateState {
    ...
    pub state_id: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub swipe_out_actions: Option<Vec<DivAction>>,
}

#[derive(Debug, Clone, Default)]
pub struct DivStateStateBuilder {
    pub animation_in: Option<DivAnimation>,
    pub animation_out: Option<DivAnimation>,
    pub div: Option<Div>,
...
impl DivStateState {
    pub fn builder() -> DivStateStateBuilder {
        DivStateStateBuilder::default()
    }
}

impl DivStateStateBuilder {
    ...
    pub fn swipe_out_actions(mut self, value: Vec<DivAction>) -> Self {
        self.swipe_out_actions = Some(value);
        self
    }
    pub fn build(self) -> DivStateState {
        DivStateState {
            ...
            swipe_out_actions: self.swipe_out_actions,
        }
    }
}
