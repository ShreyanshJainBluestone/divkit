...
pub struct DivSwitch {
    ...
    #[serde(default = "DivSwitch::default_type")]
    pub r#type: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct DivSwitchBuilder {
    ...
    pub id: Option<String>,
    pub is_enabled: Option<Expression<bool>>,
    pub is_on_variable: Option<String>,
    pub layout_provider: Option<DivLayoutProvider>,
    pub margins: Option<DivEdgeInsets>,
    pub on_color: Option<Expression<String>>,
    pub paddings: Option<DivEdgeInsets>,
...
impl DivSwitch {
    pub fn builder() -> DivSwitchBuilder {
        DivSwitchBuilder::default()
    }
    ...
    pub fn default_type() -> String { "switch".to_string() }
...
impl DivSwitchBuilder {
    ...
    pub fn is_on_variable(mut self, value: String) -> Self {
        self.is_on_variable = Some(value);
        self
    }
    ...
    pub fn on_color(mut self, value: Expression<String>) -> Self {
        self.on_color = Some(value);
        self
    }
    ...
    pub fn build(self) -> DivSwitch {
        DivSwitch {
            ...
            height: self.height.or_else(|| Some(DivSwitch::default_height())),
            id: self.id,
            is_enabled: self.is_enabled.or_else(|| Some(DivSwitch::default_is_enabled())),
            is_on_variable: self.is_on_variable.expect("missing required field 'is_on_variable'"),
            ...
            r#type: String::from("switch"),
            variable_triggers: self.variable_triggers,
            variables: self.variables,
            visibility: self.visibility.or_else(|| Some(DivSwitch::default_visibility())),
            visibility_action: self.visibility_action,
            visibility_actions: self.visibility_actions,
            width: self.width.or_else(|| Some(DivSwitch::default_width())),
        }
    }
}
