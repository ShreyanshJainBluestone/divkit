...
pub struct DivVisibilityAction {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub visibility_duration: Option<Expression<i64>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub visibility_percentage: Option<Expression<i64>>,
}

#[derive(Debug, Clone, Default)]
pub struct DivVisibilityActionBuilder {
    pub download_callbacks: Option<DivDownloadCallbacks>,
    pub is_enabled: Option<Expression<bool>>,
...
impl DivVisibilityAction {
    pub fn builder() -> DivVisibilityActionBuilder {
        DivVisibilityActionBuilder::default()
    }
    ...
    pub fn default_visibility_duration() -> Expression<i64> { Expression::value(800i64) }
    pub fn default_visibility_percentage() -> Expression<i64> { Expression::value(50i64) }
}

impl DivVisibilityActionBuilder {
    ...
    pub fn visibility_duration(mut self, value: Expression<i64>) -> Self {
        self.visibility_duration = Some(value);
        self
    }
    ...
    pub fn build(self) -> DivVisibilityAction {
        DivVisibilityAction {
            download_callbacks: self.download_callbacks,
            is_enabled: self.is_enabled.or_else(|| Some(DivVisibilityAction::default_is_enabled())),
            log_id: self.log_id.expect("missing required field 'log_id'"),
            log_limit: self.log_limit.or_else(|| Some(DivVisibilityAction::default_log_limit())),
            payload: self.payload,
            referer: self.referer,
            scope_id: self.scope_id,
            typed: self.typed,
            url: self.url,
            visibility_duration: self.visibility_duration.or_else(|| Some(DivVisibilityAction::default_visibility_duration())),
            visibility_percentage: self.visibility_percentage.or_else(|| Some(DivVisibilityAction::default_visibility_percentage())),
        }
    }
}
