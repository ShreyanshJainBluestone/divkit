...
pub struct UrlValue {
    #[serde(default = "UrlValue::default_type")]
    pub r#type: String,
    pub value: Expression<String>,
}

#[derive(Debug, Clone, Default)]
pub struct UrlValueBuilder {
    pub r#type: Option<String>,
    pub value: Option<Expression<String>>,
}

impl UrlValue {
    pub fn builder() -> UrlValueBuilder {
        UrlValueBuilder::default()
    }
    pub fn default_type() -> String { "url".to_string() }
}

impl UrlValueBuilder {
